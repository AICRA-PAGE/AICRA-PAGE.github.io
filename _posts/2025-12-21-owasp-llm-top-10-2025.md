...
OWASP LLM Top 10 2025는 AI 보안이 "프롬프트 인젝션만 막으면 된다"는 단순한 관점에서 벗어나, 공급망, 인프라, 운영, 비용까지 아우르는 **전방위적 위협 관리**가 필요함을 보여줍니다. 특히 에이전틱 AI의 확산(LLM06 Excessive Agency)과 RAG 인프라의 보편화(LLM08 Vector/Embedding)는 2026년 이후 더욱 중요해질 영역이다.
