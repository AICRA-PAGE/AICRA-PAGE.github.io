...
> 아래 CVE/사건 중 일부는 RAG 생태계에서 발생한 실제 취약점이고, 일부는 공격 시나리오를 기반으로 구성한 것입니다. 각 사례에 출처를 명시했습니다.

### 4.1 LangChain GraphCypherQAChain 프롬프트 인젝션 (CVE-2024-8309)
...
### 4.3 Chevrolet Watsonville 챗봇 사건 (2024)
