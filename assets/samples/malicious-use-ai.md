...
author: brundage
authors: ["Brundage, M.", "Avin, S.", "Clark, J.", "Toner, H.", "Eckersley, P.", "Garfinkel, B.", "Dafoe, A.", "Scharre, P.", "Zeitzoff, T.", "Filar, B."]
date: 2018-02-01
status: published
domain: "AI Governance"
abstract: "We survey the landscape of potential malicious uses of AI across digital, physical, and political security domains. As AI capabilities expand in scope and accessibility, we identify how advances in AI could be exploited for surveillance, persuasion, deception, and autonomous attacks. We propose a framework of interventions spanning policy, norms, technical safeguards, and institutional responses, arguing that proactive governance is essential before capabilities outpace defenses."
