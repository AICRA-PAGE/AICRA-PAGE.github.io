...
abstract: "We propose a linear explanation for adversarial examples and introduce FGSM (Fast Gradient Sign Method), a computationally efficient method for generating adversarial perturbations. We demonstrate that adversarial training using FGSM-generated examples regularizes models and reduces test error on MNIST from 0.94% to 0.84%. Our analysis reveals that the vulnerability to adversarial perturbations is a fundamental consequence of model linearity, not overfitting."
